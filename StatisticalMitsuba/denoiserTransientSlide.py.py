...
if __name__ == "__main__":
    ...
    statistics = np.load("./io/transient/transient_stats_2048.npy")  # [H, W, T,C, 3]
    estimands_np = statistics[:, :, i, :, 0]
    estimands_variance_np = statistics[:, :, i, :, 1]
    ...
    images = np.load("./io/transient/transient_data_2048.npy")
    image_plot = images[..., 0, :]
